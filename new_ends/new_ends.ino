...
const char* NAME__OF__WiFi = nameWifi; //Enter the name of your WiFi
const char* PASSWORD__OF__WiFi = passWifi;//Enter the password of your WiFi

const char* TOKEN__BOT=botToken;  //Enter the Bot token that is generated by the telegram.

//Our Chat Id
const char* User__CHAT__id = chatID; //Enter your Telegram Chat Id

String USER__Google_SCRIPT=userScript; //Enter your User google sheet script link
String STATEMENT__Google_Id =statementScript; //Enter your user statement sheet link
